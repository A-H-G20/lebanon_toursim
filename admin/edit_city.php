...
// Fetch the city
$stmt = $conn->prepare("SELECT * FROM city WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update = $conn->prepare("UPDATE city SET name = ? WHERE id = ?");
...
<main class="main-content">
  ...
  <form method="POST" style="max-width: 600px;">
    ...
    <div style="margin-top: 2rem;">
      ...
      <a href="city.php" class="btn-primary" style="background: var(--text-light);">Cancel</a>
    </div>
  </form>
